...
export const frenchCrmMessages = {
  resources: {
    ...
    intentions: {
      ...
      action: {
        back_to_intention: "Retour à l'effort",
        create: "Créer un effort",
        new: "Nouvel effort",
      },
      field_categories: {
        misc: "Divers",
      ...
      archived: {
        action: "Archiver",
        error: "Erreur : effort non archivé",
        list_title: "Efforts archivés",
        success: "Effort archivé",
      ...
      unarchived: {
        ...
        success: "Effort désarchivé",
      },
      updated: "Effort mis à jour",
      empty: {
        before_create: "avant de créer un effort.",
  ...
  crm: {
    ...
    activity: {
      ...
      added_note_about_intention:
        "%{name} a ajouté une note sur l'effort",
      you_added_note_about_intention:
        "Vous avez ajouté une note sur l'effort",
      added_intention: "%{name} a ajouté l'effort",
      you_added_intention: "Vous avez ajouté l'effort",
      at_company: "chez",
      to: "à",
    ...
    settings: {
      ...
      intentions: {
        ...
        currency: "Devise",
        success_help:
          "Sélectionnez les statuts d'effort à considérer comme des succès.",
